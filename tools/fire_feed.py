...
class FireFeed:
    def __init__(self, client, bbox, interval, log_path):
        self.client = client
    ...
    def poll_incidents(self):
        ...
        params.update(self._bbox_params())
...
def main():
    ...
    feed = FireFeed(client=client, bbox=args.bbox, interval=args.interval, log_path=args.log)
